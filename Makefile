...
run-test:
	@docker-compose -f docker-compose.dev.yml exec platform ./vendor/bin/phpunit --color=always --configuration phpunit.xml --filter AttributeServiceTest::testCreateWithTitleExistent
