...
class Product extends \AbstractResource
{
    ...
    {
        return $this->entityManager->getRepository(\Entity\Catalog\Product::class)
                    ->count($criteria);
    }
    ...
    {
        return collect(
            $this->entityManager->getRepository(\Entity\Catalog\Product::class)
    ...
    public function search(array $criteria = [], array $orderBy = [])
    {
        $query = $this->entityManager
                      ->getRepository(\Entity\Catalog\Product::class)
    ...
    public function flush(array $data = [])
    {
        ...
        $product = $this->fetchOne(['uuid' => $data['uuid']]) ?? new \Entity\Catalog\Product();
    ...
    public function remove(array $data = []) {
        ...
        $product = $this->fetchOne(['uuid' => $data['uuid']]);
