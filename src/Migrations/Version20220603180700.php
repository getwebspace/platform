 ...
 */
final class Version20220603180700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE catalog_measure (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) DEFAULT \'\' NOT NULL, contraction VARCHAR(255) DEFAULT \'\' NOT NULL, value DOUBLE PRECISION DEFAULT \'1\' NOT NULL, UNIQUE INDEX catalog_measure_contraction_unique (contraction), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE catalog_order (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', user_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', status_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', serial VARCHAR(12) DEFAULT \'\' NOT NULL, delivery LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', shipping DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, comment VARCHAR(255) DEFAULT \'\' NOT NULL, phone VARCHAR(25) DEFAULT \'\' NOT NULL, email VARCHAR(120) DEFAULT \'\' NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, external_id VARCHAR(255) DEFAULT \'\' NOT NULL, export VARCHAR(50) DEFAULT \'manual\' NOT NULL, system VARCHAR(500) DEFAULT \'\' NOT NULL, INDEX IDX_4C3AF221ABFE1C6F (user_uuid), INDEX catalog_order_serial_idx (serial), INDEX catalog_order_status_idx (status_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE form (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) DEFAULT \'\' NOT NULL, address VARCHAR(1000) DEFAULT \'\' NOT NULL, template LONGTEXT NOT NULL, templateFile VARCHAR(50) DEFAULT \'\' NOT NULL, recaptcha TINYINT(1) DEFAULT 1 NOT NULL, authorSend TINYINT(1) DEFAULT 0 NOT NULL, origin LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', mailto LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', duplicate VARCHAR(250) DEFAULT \'\' NOT NULL, UNIQUE INDEX UNIQ_5288FD4FD4E6F81 (address), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE params (name VARCHAR(50) DEFAULT \'\' NOT NULL, value TEXT NOT NULL, PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', group_uuid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', username VARCHAR(50) DEFAULT \'\' NOT NULL, email VARCHAR(120) DEFAULT \'\' NOT NULL, phone VARCHAR(25) DEFAULT \'\' NOT NULL, password VARCHAR(140) DEFAULT \'\' NOT NULL, firstname VARCHAR(50) DEFAULT \'\' NOT NULL, lastname VARCHAR(50) DEFAULT \'\' NOT NULL, patronymic VARCHAR(50) DEFAULT \'\' NOT NULL, birthdate DATE DEFAULT NULL, gender VARCHAR(25) DEFAULT \'\' NOT NULL, address VARCHAR(500) DEFAULT \'\' NOT NULL, additional VARCHAR(250) DEFAULT \'\' NOT NULL, allow_mail TINYINT(1) DEFAULT 1 NOT NULL, company LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', legal LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', messenger LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', status VARCHAR(100) DEFAULT \'work\' NOT NULL COMMENT \'(DC2Type:UserStatusType)\', register DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, `change` DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, website VARCHAR(100) DEFAULT \'\' NOT NULL, source VARCHAR(500) DEFAULT \'\' NOT NULL, auth_code VARCHAR(12) DEFAULT \'\' NOT NULL, language VARCHAR(5) DEFAULT \'\' NOT NULL, external_id VARCHAR(255) DEFAULT \'\' NOT NULL, token LONGTEXT DEFAULT \'a:0:{}\' NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F8250BD6 (group_uuid), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_group (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) DEFAULT \'\' NOT NULL, description TEXT NOT NULL, access LONGTEXT DEFAULT \'a:0:{}\' NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_subscriber (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', email VARCHAR(120) DEFAULT \'\' NOT NULL, date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, UNIQUE INDEX UNIQ_A679D85E7927C74 (email), PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE catalog_order ADD CONSTRAINT FK_4C3AF221E979FD32 FOREIGN KEY (status_uuid) REFERENCES catalog_order_status (uuid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catalog_order DROP FOREIGN KEY FK_4C3AF221E979FD32');
