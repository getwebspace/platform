...
!function (n) {
    ...
    if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function (a) {
        ...
        return {
            _init: function () {
                ...
                return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(" + be.FE.LinkProtocols.join("|") + "):\\/\\/", "i").test(e) ? e : e = String(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            }, isArray: function (e) {
    ...
    }, be.FE.UNICODE_NBSP = String.fromCharCode(160), be.FE.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr", "i"], be.FE.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], be.extend(be.FE.DEFAULTS, {
        ...
        function e() {
            ...
            var e = c.opts.iframe ? c.$iframe.prev().outerHeight(!0) : c.$el.prev().outerHeight(!0), t = 0, n = 0,
                r = 0, i = 0, a = 0, o = 0, s = c.node.contents(c.el), l = be(c.selection.element()).css("text-align");
        ...
        function C(e) {
            for (var t = [E("")], n = 0; n < t.length; n++) if (String.prototype.endsWith || (String.prototype.endsWith = function (e, t) {
        ...
        indent: {NAME: "indent"},
        undo: {NAME: "arrow-left", FA5NAME: "undo"},
        redo: {NAME: "arrow-right", FA5NAME: "redo"},
        insertHR: {NAME: "minus"},
    ...
    }), be.FE.DefineIcon("lineHeight", {NAME: "arrows-alt-v"}), be.extend(be.FE.POPUP_TEMPLATES, {
        "link.edit": "[_BUTTONS_]",
    ...
    }), be.FE.DefineIcon("getPDF", {NAME: "file-pdf"}), be.FE.RegisterCommand("getPDF", {
        title: "Download PDF",
        type: "button",
        focus: !1,
        undo: !1,
